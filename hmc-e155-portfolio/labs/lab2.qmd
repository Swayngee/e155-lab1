...
Note** For testing of the HSOSC I used a frequency of 2.4 Mhz to be able to see the displays clearly toggling in the simulation. 
...
![Figure 1: This block diagram shows the connection between the FPGA, its inside hardware, and LEDs used in Lab 2.](../images/lab2_topdiagram.png)
...
![Figure 2: This schematic shows the wiring and components between our dev board, the 7-segment display, and our Led's](../images/lab2_schematic_again.jpg)
